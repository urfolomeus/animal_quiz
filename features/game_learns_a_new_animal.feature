Feature: game learns a new animal
	...
	Scenario: the game asks for the actual animal the player was thinking of
		Given that the game has asked "To help me guess next time, please tell me the animal you were thinking of."
	...
	Scenario: the game asks for a distinguishing question
		Given that the game has asked "Can you give me a question to distinguish between a dolphin and a mouse?"
	...
	Scenario: the game asks for the answer to the distinguishing question for the given animal
		Given that the game has asked "What would your answer for dolphin be to 'Is it aquatic?' (y or n)?"
		When I give answer "y"
		Then the game should store answer "y"
		And I should see "Thank you. Would you like to play again?"